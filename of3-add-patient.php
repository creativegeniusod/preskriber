			...
			<div class="row d-block d-xs-block d-sm-block d-lg-flex ">
				<div class="col col-md-auto db-left">
					...
					<div class="row user-menu">
						<div class="col p-0">
							<ul>
								<li class="active"><a class="wow fadeInLeft" href="of3-add-patient.php"><i class="fa fa-plus"></i>&nbsp;&nbsp; Add New Project</a></li>
								<li><a class="wow fadeInLeft" href=""><i class="fa fa-life-ring"></i>&nbsp;&nbsp; Sell/Transfer Token</a></li>
								<li><a class="wow fadeInLeft" href="of3-change-password.php"><i class="fa fa-lock"></i>&nbsp;&nbsp; Change Password</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="db-content">
						<div class="row m-0">
							<div class="col py-3 px-4 head-sec">
								<h5 class="wow fadeInUp">Add New Patient</h5>
								<p class="m-0 lighter-color wow fadeInUp">Register a new preskriber patient by filing the input field with the appropriate information.</p>
							</div>
						</div>
