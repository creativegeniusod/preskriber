					...
					<div class="row user-menu">
						<div class="col p-0">
							<ul>
								...
								<li class="active"><a class="wow fadeInLeft" href="phm-add-affiliate.php"><i class="fa fa-plus-square"></i>&nbsp;&nbsp; Add Affliate</a></li>
					...
					<div class="db-content">
						<div class="row m-0">
							<div class="col py-3 px-4 head-sec">
								<h5 class="wow fadeInUp">Add Affliate</h5>
							</div>
						</div>
							...
							<div class="col p-0">
								<form class="mt-5 add-official wow fadeInUp">
					                ...
					                <div class="row">
					                    ...
					                    <div class="col-lg-6 col-xs-12 col-sm-6">
					                    	<div class="form-group">
					                        	<input type="text" class="form-control form-control-lg" name="" id="" placeholder="Pharmacitical Store Name">
					                        </div>
					                    </div>
					                </div>
					                <div class="row">
					                    <div class="col-lg-12 col-xs-12 col-sm-12">
					                    	<div class="form-group">
					                        	<textarea class="form-control" placeholder="Pharmacitical Store Address"></textarea>
					                        </div>
					                    </div>
					                </div>
					                <div class="row">
