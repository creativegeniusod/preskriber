					...
					<div class="row user-menu">
						<div class="col p-0">
							<ul>
								...
								<li class="active"><a class="wow fadeInLeft" href="ad-add-organisation.php"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp; Add Organisation</a></li>
								<li><a class="wow fadeInLeft" href="ad-change-password.php"><i class="fa fa-lock"></i>&nbsp;&nbsp; Change Password</a></li>
							</ul>
						</div>
					</div>
				</div>
									...
									<div class="row">
										<div class="col-lg-6 col-xs-12 col-sm-6">
											<div class="form-group">
					                        	<input type="text" class="form-control form-control-lg" name="" id="" placeholder="Acronym*">
					                        </div>
					                    </div>
					                    <div class="col-lg-6 col-xs-12 col-sm-6">
					                    	<div class="form-group">
					                        	<input type="text" class="form-control form-control-lg" name="" id="" placeholder="Name of Organisation*">
					                        </div>
					                    </div>
					                </div>
					                <div class="row">
