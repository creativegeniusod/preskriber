			...
			<div class="row d-block d-xs-block d-sm-block d-lg-flex">
				<div class="col col-md-auto db-left">
					...
					<div class="row user-menu">
						<div class="col p-0">
							<ul>
								<li class="active"><a class="wow fadeInLeft" href="ad-ap-revise-user.php"><i class="fa fa-users"></i>&nbsp;&nbsp; Revise Users</a></li>
					...
					<div class="db-content">
						<div class="row m-0">
							<div class="col py-3 px-4 head-sec">
								<h5 class="wow fadeInUp">Revise Users</h5>
						...
						<div class="row text-center">
							<div class="col mt-4 mb-4">
								<p>Displaying <b>1 - 6</b> users in total <b>6</b></p>
							</div>
						</div>
					</div>
				</div>
