			...
			<div class="row d-block d-xs-block d-sm-block d-lg-flex ">
				<div class="col col-md-auto db-left">
					...
					<div class="row user-menu">
						<div class="col p-0">
							<ul>
								<li><a class="wow fadeInLeft" href="of1-revise-luth-member.php"><i class="fa fa-users"></i>&nbsp;&nbsp; Revise LUTH Members</a></li>
								<li class="active"><a class="wow fadeInLeft" href="of1-change-password.php"><i class="fa fa-lock"></i>&nbsp;&nbsp; Change Password</a></li>
							</ul>
						</div>
					</div>
				</div>
